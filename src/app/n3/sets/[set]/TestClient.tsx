      ...
      {allDone && (
        <div className="border border-ink/20 rounded-xl px-4 sm:px-5 py-4 sm:py-5 mb-5 sm:mb-6 bg-white">
          ...
          <div className="flex gap-2 mt-3 sm:mt-4">
            ...
            <Link href="/n3/study/" className="flex-1 h-10 sm:h-11 rounded-lg bg-ink text-white text-xs sm:text-sm font-medium flex items-center justify-center gap-1.5 hover:bg-ink/80 transition-all">
              📖 Study
            </Link>
          </div>
        </div>
          ...
          return (
            <div key={i} className="border border-ink/20 rounded-lg sm:rounded-xl px-3 sm:px-5 py-2.5 sm:py-4 bg-white">
              <div className="flex items-center gap-1.5 sm:gap-3 mb-1.5 sm:mb-3">
                ...
                <Link href={`/n3/study/${q.kanji}/`} className="inline-flex items-center gap-1 rounded-md border border-ink/20 px-2 py-0.5 text-[10px] sm:text-xs text-ink/60 hover:text-ink hover:border-ink/40 transition-all bg-white">📖 detail</Link>
              </div>
              ...
              {isWrong && (
                <Link href={`/n3/study/${q.kanji}/`} className="inline-flex items-center gap-1 mt-1 rounded-md border border-ink/20 px-2.5 py-1 text-[11px] sm:text-xs text-ink/70 hover:text-ink hover:border-ink/40 transition-all bg-white">
                  📖 Study &rarr;
                </Link>
              )}
            </div>
