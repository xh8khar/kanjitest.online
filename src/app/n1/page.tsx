...
export const metadata: Metadata = {
  ...
  openGraph: { title: "JLPT N1 Kanji — Coming Soon", description: "JLPT N1 kanji study, flashcards, and tests are coming soon.", url: "https://kanjitest.online/n1" },
  twitter: { title: "JLPT N1 Kanji — Coming Soon", description: "JLPT N1 kanji study, flashcards, and tests are coming soon." },
  alternates: { canonical: "https://kanjitest.online/n1" },
}
