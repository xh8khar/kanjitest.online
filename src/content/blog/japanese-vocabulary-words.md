---
title: "The 100 Most Common Japanese Vocabulary Words for JLPT"
...
12. **多い (おおい)** — many, a lot
    - Example: 人が多いです。(There are many people.)

13. **少ない (すくない)** — few, little
...
19. **家 (いえ/うち)** — house, home
    - Example: 家に帰ります。(I go back home.)

20. **仕事 (しごと)** — work, job
    - Example: 仕事に行きます。(I go to work.)

For complete N5 vocabulary lists with interactive flashcards, visit our [N5 vocabulary page](/n5/vocabulary/) and [N5 study materials](/n5/study/).
...
Spaced repetition systems (SRS) dramatically improve long-term retention. Words you encounter today should be reviewed tomorrow, then three days later, then a week later, then a month later. Our [flashcard system](/n5/flashcards/) implements this algorithm automatically.

For a deeper dive into SRS methodology, read our guide about [how to use flashcards effectively](/blog/flashcards-for-kanji/).
