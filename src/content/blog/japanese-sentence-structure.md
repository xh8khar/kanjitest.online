---
title: "Japanese Sentence Structure: A Beginner's Guide"
...
Present affirmative: 食べます (tabemasu) — eat / will eat
Present negative: 食べません (tabemasen) — do not eat / will not eat
...
Present affirmative: 食べる (taberu) — eat
Present negative: 食べない (tabenai) — do not eat
Past affirmative: 食べた (tabeta) — ate
...
For more on when to use polite versus casual forms, see our [guide to Japanese politeness levels](/blog/japanese-politeness-levels/). Understanding です and its variants is foundational to polite speech.
...
Present negative: 大きくない (ookikunai) — is not big
...
Past affirmative: 元気でした (genki deshita) — was energetic
Present negative: 元気ではありません (genki dewa arimasen) — is not energetic

For practice with adjective usage and other grammar fundamentals, use our [N5 vocabulary pages](/n5/vocabulary/) which include example sentences for common adjectives.
...
Correct: 私は毎朝コーヒーを飲みます (Watashi wa maiasa koohii o nomimasu)
Incorrect: 私は飲みます毎朝コーヒーを
...
Correct: 駅に行きます (Eki ni ikimasu)
Incorrect: 駅行きます (Eki ikimasu)
...
Correct: 何が好きですか (Nani ga suki desu ka)
Incorrect: 何は好きですか
...
Our article on [common kanji mistakes](/blog/common-kanji-mistakes/) covers similar pitfalls in kanji learning that beginner learners should watch out for.
...
Verb negation: 食べません (tabemasen) — do not eat
い-adjective negation: 大きくない (ookikunai) — not big
な-adjective negation: 元気ではありません (genki dewa arimasen) — not energetic
Noun negation: 学生ではありません (gakusei dewa arimasen) — not a student
...
Present: 飲みます (nomimasu) — drink
Past: 飲みました (nomimashita) — drank
...
Use our [N5 study pages](/n5/study/) for grammar explanations and exercises at each step. You can also test your understanding with [timed quizzes](/n5/sets/1/) focused on sentence construction.
...
For more grammar and vocabulary help, read our guides on [essential Japanese grammar](/blog/essential-japanese-grammar/), [Japanese vocabulary words](/blog/japanese-vocabulary-words/), and [how to pass JLPT N5](/blog/how-to-pass-jlpt-n5/).