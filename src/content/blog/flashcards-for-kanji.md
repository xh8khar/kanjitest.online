---
title: "How to Use Flashcards for Kanji: A Complete Guide"
...
1. **The reading(s)** — List the on'yomi and kun'yomi clearly. For vocabulary words, provide the full reading.
2. **The meaning(s)** — One or two English definitions, prioritized by frequency
3. **An example sentence** — One sentence that demonstrates the kanji in context at the appropriate JLPT level
4. **Common compounds** — Two or three high-frequency compounds that use the character
...
Use our [N5 flashcards](/n5/flashcards/) for beginner kanji, [N4 flashcards](/n4/flashcards/) for intermediate, and [N3 flashcards](/n3/flashcards/) for advanced study. Our platform handles the spaced repetition algorithm automatically so you can focus on learning.

For specific kanji, you can access dedicated flashcard pages like our [学习 flashcard set](/n5/flashcards/学/).
...
Day 1: Learn 10 new kanji. Review them 1 hour later, 4 hours later, and again before bed.
Day 2: Review yesterday's kanji, then learn 10 new kanji.
Day 3: Review kanji from Days 1 and 2, learn 10 new kanji.
...
Write the mnemonic on the back of the card alongside the standard information. For more mnemonic techniques, read our guide on [how to remember kanji](/blog/how-to-remember-kanji/).
...
Example:
Front: 私は毎朝新聞を___ます。(read)
Back: 読みます (よみます)

### Audio Integration

Add audio recordings of the reading to your digital flashcards. Hearing the pronunciation while seeing the kanji strengthens the connection between visual and auditory memory. Our [flashcard system](/n4/flashcards/) includes native audio for all words.
...
Our [flashcard system](/n3/flashcards/) generates progress reports that show exactly which areas need more attention.
...
Use our [N5 flashcards](/n5/flashcards/) to master the 100 basic kanji and our [N4 flashcards](/n4/flashcards/) to add the next 200.
...
Our [N1 flashcards](/n1/flashcards/) include sentences drawn from JLPT-level authentic materials.
...
1. **Before reading:** Preview new kanji in your flashcard deck that will appear in the article or text you plan to read
2. **After reading:** Create new cards from unknown words you encountered
3. **Before listening:** Review pronunciation cards for words appearing in your listening material
4. **After class or tutoring:** Add new vocabulary from your session to your daily review queue

For a complete daily study plan that integrates multiple methods, read our guide on [daily Japanese study routines](/blog/daily-japanese-study-routine/).
